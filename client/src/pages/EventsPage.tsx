...
import { Calendar, Clock, MapPin, Users, ChevronRight, Bell, CheckCircle2 } from 'lucide-react';
      ...
      {activeTab === 'upcoming' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fadeIn">
          {(events.upcoming || []).map(event => (
            <div
              key={event.id}
              className="bg-white rounded-3xl border border-uday-peach/60 p-6 sm:p-7 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
            >
